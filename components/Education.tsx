...
const Education = () => {
  ...
  const certifications = [
    ...
    {
      title: "OCI Database AWS Certified Architect Professional",
      issuer: "Oracle",
      date: "OCT 2025",
      credentialUrl:
        "https://catalog-education.oracle.com/ords/certview/sharebadge?id=48DCA9766AF32A166F58106B7E6F132C15FC9814954C897C9D186DF6E3B546A2",
      level: "Professional",
      color: "from-red-500 to-orange-600",
    },
    {
