...
interface ScrollAnimationOptions {
  ...
  triggerOnce?: boolean;
  staggerDelay?: number;
  animationType?: 'fadeIn' | 'slideUp' | 'slideLeft' | 'slideRight' | 'scale' | 'blur';
  duration?: number;
  easing?: string;
}
...
export const useScrollAnimation = (options: ScrollAnimationOptions = {}) => {
  ...
  }, [threshold, rootMargin, triggerOnce, staggerDelay, animationType, duration, easing, isMobile]);
...
export const useStaggeredAnimation = (childSelector: string = '[data-stagger]') => {
